...
iNTUition v8.0 introduced a virtual space where interaction with other hackathon-goers and sponsors. There were a few fun 'places' to be, including an arcade, sponsor buildings, and hacker arena. There were also a few additional features like a universal jukebox and emotes. We had some fun in using the emotes mainly, though!
...
<figure>
    <img src="images/taking-part-in-intuition-v8.0/002.png" alt="Example of GitHub parsing the Co-authored-by trailer by four commiters" />
    <img src="images/taking-part-in-intuition-v8.0/003.png" alt="Example of GitHub parsing the Co-authored-by trailer by two commiters" />
    <figcaption>GitHub parses commits with multiple commiters in a pretty neat way.</figcaption>
</figure>
