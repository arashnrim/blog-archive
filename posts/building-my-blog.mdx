---
title: "Learning Log: Building My Blog"
date: 5 December 2021
description: Getting to know the technical details on how I built my blog from scratch using Next.js and Tailwind CSS.
...
<Prompt title="Heads up!" status="warn">I expect the post ahead to be long for most people, and details can get very technical. If you are not as interested in learning more about the details of how I made my blog, this post may not be for you!</Prompt>
...
<Resource links={[{ title: "Jamstack: Static Site Generators", link: "https://jamstack.org/generators" }]} />
...
<Resource links={[{ title: "Tailwind CSS: Installation", link: "https://tailwindcss.com/docs/installation" }]} customBody="For detailed instructions on installing Tailwind CSS, read here:" />
...
<Prompt title="Heads up!" status="warn">This section assumes that Next.js is the framework used to develop the website.</Prompt>
...
<Resource links={[
    { title: "Next.js: Dynamic Routes", link: "https://nextjs.org/docs/routing/dynamic-routes" },
    { title: "Next.js: getStaticPaths", link: "https://nextjs.org/docs/basic-features/data-fetching#getstaticpaths-static-generation" },
    { title: "Next.js: getStaticProps", link: "https://nextjs.org/docs/basic-features/data-fetching#getstaticprops-static-generation" }
]} />
...
<Resource links={[
    ...
    { title: "next-mdx-remote", link: "https://github.com/hashicorp/next-mdx-remote" }
...
<Resource links={[
    { title: "TypeScript: Interfaces", link: "https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#interfaces" },
    { title: "React: useMemo", link: "https://reactjs.org/docs/hooks-reference.html#usememo" },
    { title: "MDX: Frontmatter", link: "https://mdxjs.com/guides/frontmatter/" },
    { title: "Tailwind CSS: Typography Plugin", link: "https://tailwindcss.com/docs/plugins#typography" }
]} />
...
<Resource links={[
    { title: "Jamstack: Static Site Generators", link: "https://jamstack.org/generators" },
    { title: "Tailwind CSS: Installation", link: "https://tailwindcss.com/docs/installation" },
    { title: "Next.js: Dynamic Routes", link: "https://nextjs.org/docs/routing/dynamic-routes" },
    { title: "Next.js: getStaticPaths", link: "https://nextjs.org/docs/basic-features/data-fetching#getstaticpaths-static-generation" },
    { title: "Next.js: getStaticProps", link: "https://nextjs.org/docs/basic-features/data-fetching#getstaticprops-static-generation" },
    { title: "mdx-bundler", link: "https://github.com/kentcdodds/mdx-bundler" },
