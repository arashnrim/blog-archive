...
This blog is built with [Next.js](https://nextjs.org), styled with [Tailwind CSS](https://tailwindcss.com), and deployed on [Vercel](https://vercel.com). The design was intentionally made to replicate the design system from [my website](https://arashnrim.me), so it wasn't too difficult trying to port over a design system previously built the same way over to this project.

I've written [another article](https://blog.arashnrim.me/building-my-blog) going through the nitty-gritty of how this blog was made in the form of a learning log. If you're interested in that, feel free to check that blog post out!
